 ...
 */
public class AnimalTrainer extends Artist {

    public AnimalTrainer(String name, String surName, String numTel, int age, int salary) {
    ...
    public String toString() {
        ...
        String info = "AnimalTrainer - " + toString();
        return info;
    }
}
